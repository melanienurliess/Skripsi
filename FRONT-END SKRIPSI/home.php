...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #B0A695;">
  ...
  <div class="collapse navbar-collapse" style="margin-left: 500px;" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      <button class="btn btn-primary mr-3" href="register.php" type="submit" Style="background-color: #B2C8BA;">Sign Up</button>
      <button class="btn btn-secondary mr-3" type="submit" Style="background-color: #D6C7AE;">Login</button>
    </form>
  </div>
</nav>
</header>
...
<!-- ABOUT US -->
<div class="container-fluid py-5" Style="background-color:  #B0A695; margin-top: 20px;">
  <div class="container text-center">
    <h3>About Us</h3>
    <p class="fs-5 mt-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis suscipit ab 
      ipsum esse unde qui minima necessitatibus, quaerat voluptatibus accusantium mollitia 
      ducimus! Consequatur quos dolorum non tempore, aperiam expedita autem delectus voluptate 
      alias maiores officiis quisquam temporibus deserunt eius quidem quaerat repellat molestiae 
      optio doloremque eum? Voluptatum quidem porro non deserunt sequi? Architecto, inventore facere 
      recusandae sit non atque numquam tempora accusantium, modi unde at. Officiis neque dicta minus 
      quisquam, nihil omnis libero sed repellat illo voluptatibus recusandae tempore eaque.</p>
  </div>
</div>
<!-- Produk -->
